...
@pytest.mark.thread_unsafe("tmp_path is thread-unsafe")
...
@pytest.mark.slow
@pytest.mark.thread_unsafe(reason="crash, memmap is thread-unsafe")
...
@pytest.mark.thread_unsafe("tmpdir is thread-unsafe")
...
@pytest.mark.skipif(IS_WASM, reason="memmap doesn't work correctly")
@pytest.mark.thread_unsafe(reason="memmap is thread-unsafe")
...
@pytest.mark.thread_unsafe(reason="Can crash with low memory")
